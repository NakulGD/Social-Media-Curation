...
/**
 * The PubSubMessage class is a Java object that represents
 * a message with a unique identifier and timestamp.
 * The message has a sender and receiver(s), content, and type.
 * The class provides methods to access the message's ID, timestamp, content, sender, receiver(s), and type.
 * It also provides methods for checking whether the message is transient,
 * and for comparing the message to others using its ID.
 */
